...
HashBrown = Checkbutton(f2Top,text = 'Hash Brown\t\t50', variable = var9, onvalue = 1, offvalue = 0,
...
ToastedBage1 =  Checkbutton(f2Top,text = 'ToastedBage1\t\t60', variable = var10, onvalue = 1, offvalue = 0,
...
PancakesSyrup= Checkbutton(f2Top,text = 'PancakeSyrup\t\t80', variable = var11, onvalue = 1, offvalue = 0,
...
#
PineappleStick = Checkbutton(f2Top,text = 'PineappleStick\t\t70', variable = var12, onvalue = 1, offvalue = 0,
...
ChocolateMuffin = Checkbutton(f2Top,text = 'ChocolateMuffin\t\t90', variable = var13, onvalue = 1, offvalue = 0,
