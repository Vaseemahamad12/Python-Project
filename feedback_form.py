...
def onClick():
    tkinter.messagebox.showinfo("Attention","Your Feedback Successfully Submit")
...
button=Button(root,  text= "SUBMIT", padx = 40,  pady = 10, fg = "white", bg = "black", font = ("SUBMIT", 10),command = onClick).place(x = 450, y = 540)

button2=Button(root,  text= "CANCEL", padx = 40,  pady = 10, fg = "white", bg = "black", font = ("CANCEL", 10), command = close_window).place(x = 620, y = 540)
