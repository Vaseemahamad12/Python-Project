...
button7 = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "7", 
	command = lambda: btnclick(7))
button7.grid(row = 1, column =0)


button8 = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "8", 
	command = lambda: btnclick(8))
button8.grid(row = 1, column =1)


button9 = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "9", 
	command = lambda: btnclick(9))
button9.grid(row = 1, column =2)


buttonAdd = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "+", 
...
buttonSub = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "-", 
	command = lambda: btnclick("-"))
...
buttonMul = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "*", 
	command = lambda: btnclick("*"))
...
button0 = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "0", 
	command = lambda: btnclick(0))
button0.grid(row = 4, column =0)


buttonClr = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "C", 
	command =  btnClear)
buttonClr.grid(row = 4, column =1)


buttonEqu = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "=", 
	command = btnEquals)
buttonEqu.grid(row = 4, column =2)


buttonDiv = Button(root, padx = 16, pady = 16,bd = 8, fg = "black", font = ('arial',20,'bold'),text = "/", 
	command = lambda: btnclick("/"))
